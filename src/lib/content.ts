...
export const PROJECTS_COMMERCIAL: Project[] = [
  ...
  },
  {
    ...
    long:
      "Synapt собирает команду под задачу и строит продукты — от прототипа до полной разработки. Фиксированные сроки и цена до старта, сначала спецификация — потом разработка. Код остаётся у клиента.",
