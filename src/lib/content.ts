...
export const PROJECTS_COMMERCIAL: Project[] = [
  {
    ...
    long:
      "Снимаем полный цикл: документальные фильмы, интервью, подкасты, шоу, короткие форматы для соцсетей, ивенты и корпоративные репортажи. Работаем с командой проверенных специалистов — операторы, монтаж, цветокоррекция, звук, графика. Главный кейс 2025 года — полнометражный фильм про МФТИ с предпринимателями Forbes и нобелевским лауреатом Константином Новосёловым. Премьера прошла в Долгопрудном, собрала 400 человек.",
...
export const PROJECTS_SOCIAL: Project[] = [
  {
    ...
    short: "Запускаем сервис, через который выпускники напрямую смогут поблагодарить преподавателей за участие в их становлении.",
    long:
      "Наша идея: дать выпускникам учебных заведений способ напрямую поддерживать своего преподавателя — адресно, прозрачно, по подписке. Выпускник сам выбирает, кому помочь, и видит, что деньги дошли.",
  ...
  },
  {
    ...
    long:
      "Встречаемся, помогаем освоить навыки работы с ИИ, делимся и обмениваемся экспертизой, помогаем ребятам устраиваться, расти в карьере и делать свои проекты.",
  ...
  },
  {
    ...
    short: "Небольшая камерная группа, в которой встречаемся и делимся прогрессом, ошибками, опытом.",
    long:
      "Для студентов, которым одной учёбы мало, чтобы расти быстрее и легче.",
...
export const PREMIERE_GALLERY = [
  { src: "/photos/film-premiere.jpg", alt: "Постер фильма про МФТИ", objectPosition: "top" },
