...
export const PROJECTS_COMMERCIAL: Project[] = [
  ...
  },
  {
    ...
    tag: "HR-направление",
    short: "Подбираем профессионалов для бизнеса: ассистентов, маркетологов, топ-менеджеров. Работаем с сообществами МФТИ, ВШЭ, МГИМО и других ведущих вузов России.",
    long:
      "Подбираем профессионалов для предпринимателей: бизнес-ассистентов, операционных менеджеров, маркетологов, топ-менеджеров. Работаем с сообществом студентов МФТИ, ВШЭ, МГИМО и других ведущих вузов России — это даёт доступ к талантам, которых ещё нет на открытом рынке.",
...
export const PROJECTS_SOCIAL: Project[] = [
  {
    ...
    slug: "donation",
    category: "social",
    name: "Платформа поддержки преподавателей",
    tag: "С Виктором Кузнецовым",
    short: "Сервис, через который выпускники напрямую смогут поблагодарить преподавателей за вклад в их становление.",
    long:
      "Запускаем сервис, через который выпускники напрямую смогут поддержать своего преподавателя — адресно, прозрачно, по подписке. Выпускник сам выбирает, кому помочь, и видит, что деньги дошли.",
  ...
  },
  {
    ...
    long:
      "Сообщество студентов ведущих вузов России. Встречаемся, помогаем освоить навыки работы с ИИ, делимся и обмениваемся экспертизой, помогаем ребятам устраиваться, расти в карьере и делать свои проекты. АССИСТ+ — место, где студенты и предприниматели находят друг друга.",
    cover: "/photos/assist-plus.jpg",
  },
  {
    id: "forum-group",
    ...
    short: "Небольшая камерная группа: встречаемся, делимся прогрессом, ошибками, опытом. Для студентов, которым одной учёбы мало.",
    long:
      "Небольшая камерная группа, в которой встречаемся и делимся прогрессом, ошибками, опытом. Для студентов, которым одной учёбы мало, чтобы расти быстрее и легче.",
