...
export const PROJECTS_SOCIAL: Project[] = [
  ...
  },
  {
    ...
    cover: "/photos/assist-cover-new.jpg",
  },
  {
    id: "forum-group",
    slug: "forum-group",
...
export const STORY_SHORT = {
  ...
  body:
    "Родился и вырос в Петрозаводске. Окончил Лицей №1 как лучший лицеист. ЕГЭ на 302* балла, победитель перечневой олимпиады по математике. Выиграл 100% грант на обучение в МФТИ × Сколково, один из 20 на всю Россию, 8 миллионов рублей. Сейчас в Москве, делаю проекты в AI, IT, образовании и медиа",
};
...
export const FOOTER_PROJECTS = [
  ...
  { name: "Подбор специалистов", href: "/hr" },
