        ...
        <>
          ...
          <Section eyebrow="Что делаем" title="Полный цикл видео-продакшна">
            <p>
              ...
              Полностью сопровождаем проект в рамках утверждённого бюджета.
            </p>
            <p>
              Каждый проект собираем под задачу: операторы, монтаж,
              цветокоррекция, звук, графика. Беремся за работу даже без чёткого
              ТЗ — помогаем сформулировать идею, структуру и стратегию.
            </p>
            <p>
              ...
              Julius Meinl, Ростех, Московский спорт.
            </p>
          </Section>
        ...
        <>
          ...
          <Section eyebrow="Что это" title="Практика применения нейросетей">
            <p>
              ...
              и для всех, кто хочет быть актуальным и востребованным специалистом.
            </p>
            <p>
              ...
              конкретные сценарии применения, инструменты и результаты в цифрах.
            </p>
          </Section>
            ...
            <div className="max-w-[820px] mx-auto px-5 sm:px-8 lg:px-12">
              <Reveal>
                ...
                <p className="text-[15px] leading-[1.6] text-granite-gray mb-4">
                  ...
                  перспективный специалист, обращаемся напрямую к этой аудитории.
                </p>
                <Link
                  href="/assist"
        ...
        <>
          ...
          <Section eyebrow="Что это" title="Сообщество молодёжи титульных вузов">
            ...
            <p>
              ...
              студенты и предприниматели находят друг друга.
            </p>
          </Section>
          ...
          <Section eyebrow="Как попасть" title="Кого ждём">
            <p>
              ...
              вкладываться в проекты, общаться и учиться быстрее обычного.
            </p>
            <p>
