...
export function ProjectContent({ slug }: { slug: string }) {
  switch (slug) {
        ...
        <>
          <Section eyebrow="Что делаем" title="Полный цикл видео-продакшна">
            <p>
              ...
              интервью, подкасты, шоу, документальное, короткие форматы для
              соцсетей, ивенты, корпоративные мероприятия и репортажи.
            </p>
            <p>
              Работаем с командой сильных и проверенных специалистов —
              операторская группа, монтаж, цветокоррекция, звук, графика —
              и доводим идеи до релиза.
            </p>
          </Section>
          ...
          <Section eyebrow="Кейс года" title="Фильм про МФТИ">
            <p>
              ...
              (нобелевский лауреат), Михаил Кучмент (Hoff), Игорь Рыбаков
              (Технониколь, Forbes), Дмитрий Ливанов (ректор МФТИ), Виктор
              Кузнецов, Алексей Половинкин, Татьяна Савельева, Полина Бабаева,
    ...
    case "it-studio":
      return (
        <>
          <Section eyebrow="Что делаем" title="AI и IT разработка для бизнеса">
            <p>
          ...
          <Section eyebrow="Как работаем" title="Предсказуемый результат на каждом этапе">
            <p>
              За 4–8 недель сдаём первый работающий результат. Этапы, суммы и
              сроки фиксируются в договоре до старта — никаких пересмотров по
              ходу работы.
            </p>
            <p>
              После запуска 30 дней сопровождаем и дорабатываем без доплат.
              Специалист подбирается под конкретную задачу: AI-архитектура,
              full-stack, мобильная разработка — привлекаем того, кто нужен
        ...
        <>
          <Section eyebrow="Что это" title="Практика применения нейросетей">
            <p>
              ...
              занятия от нашей команды по применению AI в работе и личной
              эффективности. Для предпринимателей, для тех, кто принимает
              решения, и для всех, кто хочет быть актуальным и востребованным
            ...
            items={[
              {
                ...
                description:
                  "Новости AI-мира, кейсы применения, инструменты и результаты в цифрах.",
                icon: MessageSquare,
              },
              {
                title: "Курс",
                description:
                  "Практические занятия по применению AI в работе и личной эффективности.",
                icon: Sparkles,
              },
              {
                title: "Для принимающих решения",
                description:
                  "Не для разработчиков — для предпринимателей и тех, кто хочет встроить AI в процессы.",
                icon: Briefcase,
              },
            ]}
          />
        ...
        <>
          <Section eyebrow="Что делаем" title="Подбираем команды для предпринимателей">
            ...
            <p>
              ...
              воронка кандидатов. Это даёт скорость, которой обычно нет у
              внешних рекрутеров.
            </p>
          </Section>
            ...
            <div className="max-w-[820px] mx-auto px-5 sm:px-8 lg:px-12">
              <Reveal>
                ...
                <p className="text-[15px] leading-[1.6] text-granite-gray mb-4">
                  ...
                  перспективный кандидат, обращаемся напрямую к этой
                  аудитории.
                </p>
                <Link
                  href="/assist"
    ...
    case "mentoring":
      return (
        <>
          ...
          <Section eyebrow="Кому подходит" title="">
            <p>
        ...
        <>
          <Section eyebrow="Идея" title="Способ сказать спасибо преподавателю">
            ...
            <p>
              ...
              учил. Выпускник выбирает конкретного преподавателя и переводит
              подписочный донат. Преподаватель видит, кто его поддерживает.
            </p>
          </Section>
          ...
          <FeaturesBlock
            items={[
              ...
              {
                title: "Подписка, а не разовый платёж",
                description:
              ...
              },
              {
                ...
                description:
                  "Дальше масштабируем на все учебные заведения России.",
                icon: Award,
              },
            ]}
          />
      ...
      return (
        <>
          <Section eyebrow="Что это" title="Сообщество молодёжи титульных вузов">
            ...
            <p>
              Регулярно проводим онлайн- и офлайн-встречи, делимся обучением по
              нейросетям для студенческих проектов и личной эффективности, даём
              доступ к предпринимателям — помогаем участникам находить
              стажировки и первую работу у проверенных лидеров своих ниш.
            </p>
          </Section>
            ...
            items={[
              {
                title: "Встречи",
                description:
                  "Регулярные онлайн- и офлайн-встречи. Обмен экспертизой, нетворкинг.",
                icon: Users,
              },
              {
                title: "Обучение AI",
              ...
              },
              {
                ...
                description:
                  "Помогаем устраиваться, расти в карьере и запускать свои проекты.",
                icon: Briefcase,
              },
            ]}
          />
      ...
      return (
        <>
          <Section eyebrow="Что это" title="Формат, где растут быстрее">
            ...
            <p>
              Это работает потому, что рядом такие же люди, которые знают, чего
              хотят. Ритм — регулярный: каждый месяц общая встреча, в
              перерыве групповые сессии. Ещё есть закрытый чат — живое,
              честное общение, нетворкинг, обмен ресурсами и ивенты.
            </p>
          </Section>
        ...
        <>
          <Section eyebrow="Школьный опыт" title="Построил совет старшеклассников в Карелии">
            <p>
              ...
              поддерживали младшие классы и помогали строить взаимодействие
              со старшими.
            </p>
            <p>
              Этот опыт научил собирать людей вокруг идеи, делегировать,
              добиваться эффективных решений. Сейчас помогаю советам
              в других школах.
            </p>
          </Section>
